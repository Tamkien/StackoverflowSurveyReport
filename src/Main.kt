...
//        for (r in verifiedResponds) println(r.toString())
//        val edLevelPairs: MutableList<Pair<String, Int>> = ArrayList()
//        edLevelPairs.add(Pair("I never completed any formal education", 0))
//        edLevelPairs.add(Pair("Primary/elementary school", 1))
//        edLevelPairs.add(Pair("Secondary school (e.g. American high school, German Realschule or Gymnasium, etc.)", 2))
//        edLevelPairs.add(Pair("Some college/university study without earning a degree", 3))
//        edLevelPairs.add(Pair("Associate degree (A.A., A.S., etc.)", 4))
//        edLevelPairs.add(Pair("Bachelorâ€™s degree (B.A., B.S., B.Eng., etc.)", 5))
//        edLevelPairs.add(Pair("Masterâ€™s degree (M.A., M.S., M.Eng., MBA, etc.)", 6))
//        edLevelPairs.add(Pair("Professional degree (JD, MD, etc.)", 7))
//        edLevelPairs.add(Pair("Other doctoral degree (Ph.D., Ed.D., etc.)", 8))
